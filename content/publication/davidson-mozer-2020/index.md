...
date: '2020-06-01'
publishDate: '2024-11-21T17:24:12.659106Z'
authors:
- Guy Davidson
- Michael C. Mozer
publication_types:
- '1'
abstract: We explore the behavior of a standard convolutional neural net in a continual-learning
  setting that introduces visual classification tasks sequentially and requires the
  net to master new tasks while preserving mastery of previously learned tasks. This
  setting corresponds to that which human learners face as they acquire domain expertise
...
url_pdf: https://openaccess.thecvf.com/content_CVPR_2020/papers/Davidson_Sequential_Mastery_of_Multiple_Visual_Tasks_Networks_Naturally_Learn_to_CVPR_2020_paper.pdf
links:
- name: arXiv
  url: https://arxiv.org/abs/1905.10837
- name: URL
  url: https://ieeexplore.ieee.org/document/9157800
---
